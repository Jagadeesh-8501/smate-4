...
(function ($) {
   ...
   // ============================================================================
	...
	if ($("#tt-dark-style-default").length) {
		...
		$(".tt-style-switch").on("click", function() {
			...
			$("body").hasClass("tt-light-style-on") ? (localStorage.setItem("lightstyle", "false"), 
			$(".tt-style-switch")) : (localStorage.setItem("lightstyle", "true"));
